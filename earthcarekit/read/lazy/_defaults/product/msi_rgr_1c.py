...
_ATTRS_REGISTRY: Final[dict[str, dict[str, str]]] = {
    "vis": {"label": "Radiance at 670 nm", "units": UNITS_MSI_RADIANCE},
    "vis_uncertainty": {"label": "Radiance uncertainty at 670 nm", "units": UNITS_MSI_RADIANCE},
    "nir": {"label": "Radiance at 865 nm", "units": UNITS_MSI_RADIANCE},
    "nir_uncertainty": {"label": "Radiance uncertainty at 865 nm", "units": UNITS_MSI_RADIANCE},
    "swir1": {"label": "Radiance at 1650 nm", "units": UNITS_MSI_RADIANCE},
    "swir1_uncertainty": {
        "label": "Radiance uncertainty at 1650 nm",
        "units": UNITS_MSI_RADIANCE,
    },
    "swir2": {"label": "Radiance at 2210 nm", "units": UNITS_MSI_RADIANCE},
    "swir2_uncertainty": {
        "label": "Radiance uncertainty at 2210 nm",
        "units": UNITS_MSI_RADIANCE,
    },
    "tir1": {"label": "BT at 8.8 µm", "units": UNITS_KELVIN},
    "tir1_uncertainty": {"label": "BT uncertainty at 8.8 µm", "units": UNITS_KELVIN},
    "tir2": {"label": "BT at 10.8 µm", "units": UNITS_KELVIN},
    "tir2_uncertainty": {"label": "BT uncertainty at 10.8 µm", "units": UNITS_KELVIN},
    "tir3": {"label": "BT at 12.0 µm", "units": UNITS_KELVIN},
    "tir3_uncertainty": {"label": "BT uncertainty at 12.0 µm", "units": UNITS_KELVIN},
    "vis_line_quality_status": {"label": "Line quality (VIS)", "units": UNITLESS},
    "nir_line_quality_status": {"label": "Line quality (NIR)", "units": UNITLESS},
    "swir1_line_quality_status": {"label": "Line quality (SWIR-1)", "units": UNITLESS},
    "swir2_line_quality_status": {"label": "Line quality (SWIR-2)", "units": UNITLESS},
    "tir1_line_quality_status": {"label": "Line quality (TIR-1)", "units": UNITLESS},
    "tir2_line_quality_status": {"label": "Line quality (TIR-2)", "units": UNITLESS},
    "tir3_line_quality_status": {"label": "Line quality (TIR-3)", "units": UNITLESS},
    "vis_pixel_quality_status": {"label": "Pixel quality (VIS)", **_PIXEL_QUALITY_ATTRS},
    "nir_pixel_quality_status": {"label": "Pixel quality (NIR)", **_PIXEL_QUALITY_ATTRS},
    "swir1_pixel_quality_status": {"label": "Pixel quality (SWIR-1)", **_PIXEL_QUALITY_ATTRS},
    "swir2_pixel_quality_status": {"label": "Pixel quality (SWIR-2)", **_PIXEL_QUALITY_ATTRS},
    "tir1_pixel_quality_status": {"label": "Pixel quality (TIR-1)", **_PIXEL_QUALITY_ATTRS},
    "tir2_pixel_quality_status": {"label": "Pixel quality (TIR-2)", **_PIXEL_QUALITY_ATTRS},
    "tir3_pixel_quality_status": {"label": "Pixel quality (TIR-3)", **_PIXEL_QUALITY_ATTRS},
    "vis_solar_spectral_irradiance": {
        "label": "Spectral irradiance (VIS)",
        "units": UNITS_SPECTRAL_IRRADIANCE,
    },
    "nir_solar_spectral_irradiance": {
        "label": "Spectral irradiance (NIR)",
        "units": UNITS_SPECTRAL_IRRADIANCE,
    },
    "swir1_solar_spectral_irradiance": {
        "label": "Spectral irradiance (SWIR-1)",
        "units": UNITS_SPECTRAL_IRRADIANCE,
    },
    "swir2_solar_spectral_irradiance": {
        "label": "Spectral irradiance (SWIR-2)",
        "units": UNITS_SPECTRAL_IRRADIANCE,
    },
}

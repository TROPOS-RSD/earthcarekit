...
_OTHER: Final[_CmapRegistry] = {
    ...
    "height": _get_cmap("navia"),
    "temperature_kelvin": _get_cmap("coolwarm"),
    "temperature_celsius": _get_cmap("coolwarm"),
    "pressure": _get_cmap("nuuk"),
    "n50_nd": _get_cmap("roma_r"),
    "n100_d": _get_cmap("roma_r"),
    "n250_d": _get_cmap("roma_r"),
    "n250_nd": _get_cmap("roma_r"),
    "nccn_d": _get_cmap("roma_r"),
    "nccn_nd": _get_cmap("roma_r"),
    "s_d": _get_cmap("roma_r"),
    "s100_d": _get_cmap("roma_r"),
    "s_nd": _get_cmap("roma_r"),
    "v_d": _get_cmap("roma_r"),
    "v_nd": _get_cmap("roma_r"),
    "m_d": _get_cmap("roma_r"),
    "m_nd": _get_cmap("roma_r"),
    "ninp_imm_dm15_dust": cm.chiljet2.get_cmap,
    "ninp_imm_dm10_nondust": cm.chiljet2.get_cmap,
    "ninp_dep_u17_dust": cm.chiljet2.get_cmap,
    "ninp_dep_u17_soot": cm.chiljet2.get_cmap,
    "ninp_imm_u17_dust": cm.chiljet2.get_cmap,
    "ninp_imm_u17_soot": cm.chiljet2.get_cmap,
    "ninp_imm_mc18_marine": cm.chiljet2.get_cmap,
}
